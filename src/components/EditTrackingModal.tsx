    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-gray-800 shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div>
            <h2 className="text-lg font-bold text-gray-900 dark:text-white">Modifier le tracking</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {fulfillment.line_items.length > 0 && (
            <div>
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Articles inclus</p>
              <div className="space-y-1 max-h-32 overflow-y-auto">
                {fulfillment.line_items.map((item) => (
                  <div key={item.id} className="flex justify-between text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 rounded-lg px-3 py-2">
          ...
          <div className="flex items-center justify-between pt-2">
            <button
              ...
              className="rounded-lg border border-red-300 dark:border-red-700 px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              Annuler le bon
            </button>
